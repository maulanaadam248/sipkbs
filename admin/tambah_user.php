...
<style>
    /* Styling khusus form input agar terlihat premium */
    ...
    <div class="container-fluid px-4 px-lg-5">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4">
            <div class="mb-3 mb-md-0">
                <h2 class="h3 mb-0 text-gray-800 fw-bold">Tambah User</h2>
                <p class="text-muted mb-0">Tambahkan pengguna baru dan tentukan hak aksesnya</p>
            </div>
            <div>
        ...
        <div class="card border-0 shadow-sm rounded-4 bg-white overflow-hidden mb-5">
            <div class="card-header bg-white py-3 border-bottom">
                <h6 class="m-0 font-weight-bold text-success"><i class="fas fa-user-plus me-2"></i>Form Pengisian Data User</h6>
            </div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control px-3 py-2 bg-light-input border-start-0 ps-0" id="nama" name="nama" placeholder="Masukkan nama lengkap" required>
                            </div>
                        </div>
                        ...
                        <div class="col-12 border-bottom py-2 my-2"></div> <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control px-3 py-2 bg-light-input border-start-0 ps-0" id="username" name="username" placeholder="Buat username (tanpa spasi)" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="password" class="form-control px-3 py-2 bg-light-input border-start-0 ps-0" id="password" name="password" placeholder="Buat kata sandi" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-select px-3 py-2 bg-light-input border-start-0 ps-0" id="role" name="role" required onchange="toggleBalai()">
                                    ...
                                    <option value="operator">Operator Balai</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-select px-3 py-2 bg-light-input border-start-0 ps-0" id="balai_id" name="balai_id">
                                    <option value="" selected>Tidak terikat instansi (Semua Akses)</option>
                                    <?php 
                                    // Reset pointer agar bisa diloop
                                    mysqli_data_seek($result_balai, 0);
                                    while($balai = mysqli_fetch_assoc($result_balai)): 
                                    ?>
                                        <option value="<?= $balai['id_balai']; ?>"><?= htmlspecialchars($balai['nama_balai']); ?></option>
                                    <?php endwhile; ?>
                                </select>
                            </div>
                            <small class="text-muted" style="font-size: 0.75rem;"><i class="fas fa-info-circle me-1"></i>Wajib diisi jika role adalah Operator.</small>
                        </div>
